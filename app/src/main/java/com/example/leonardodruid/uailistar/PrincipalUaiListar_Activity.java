...
public class PrincipalUaiListar_Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_principal_uai_listar_);
        ...
        button_Deslogar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    ...
                    Intent intent_VoltarTelaLogin = new Intent(getApplicationContext(), Login_Email.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.principal_uai_listar_, menu);
        return true;
    }
